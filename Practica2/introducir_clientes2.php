...
// obtenemos el fichero jpg-binario del buffer y lo almacenaen la variable jpg
...
// Creamos la consulta y asignamos el resultado a lavariable $result
$result = $conexion->query($SentenciaSQL);
if (!$result){
echo "<br>Error al introducir el Cliente en la
Base de Datos";}
else{
echo "<br>El Cliente se ha introducido con exito
en la Base de Datos";}
?>
